...
class FinalPrjEngine:
    ...
    def loadData(self):
        ...
        self.books = pd.read_csv(
            "C:/Users/halem/Downloads/Hale Okul - TSOM/Module3/Final Python Project/Data/books_data.csv")
        self.book_ratings = pd.read_csv(
            "C:/Users/halem/Downloads/Hale Okul - TSOM/Module3/Final Python Project/Data/Books_rating.csv")
    ...
    def performSanityChecks(self):
        ...
        merged_df.to_csv('merged_df.csv', index=False) # Kazuki  added to use for prediction
        return merged_df
